...
public:
    ...
    int start() {
        if (!FLAGS_run_in_XPS_cluster) {
            FLAGS_conf = "127.0.1.1:8100:0,127.0.1.1:8101:0,127.0.1.1:8102:0,";
        }
        ...
        // std::string prefix_log_storage = "state_continuous://" + FLAGS_data_path;
        //- If use in-memory log storage
        ...
        // node_options.raft_meta_uri = "state_continuous://" + null_path;
